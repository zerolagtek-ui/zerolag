...
import { getStoredProducts, syncHeroSlidesFromSupabase, formatSlideImageUrl } from '@/lib/storeManager';
            ...
            <div className="relative w-full max-w-md lg:max-w-lg 2xl:max-w-xl h-full min-h-[260px] lg:min-h-[360px] flex items-center justify-center">
              {!isImageBroken && slideImgSrc ? (
                <Image
                  ...
                  unoptimized
                  className="object-contain drop-shadow-[0_20px_30px_rgba(0,0,0,0.8)] rounded-xl transition-all duration-500 hover:scale-105"
                  onError={() => {
                    if (currentSlide?.id) {
